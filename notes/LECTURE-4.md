...
- **Visual: Motor Settling**
	![Motor Settling](/assets/module-b/lecture-4/motor-settling.png)
...
- **Visual: Instantaneous Error**
	![Instantaneous Error](/assets/module-b/lecture-4/instantaneous-error.png)
...
- **Visual: Projected Error**
	![Projected Error](/assets/module-b/lecture-4/projected-error.png)
